...
HD_PWD='D:/VivadoCode/AXI_Stream_DMA/bus_bandwidth_test/interface_none/interface_none.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_full_master_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_full_master_v1_0.tcl

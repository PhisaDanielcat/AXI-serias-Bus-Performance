...
HD_PWD='D:/VivadoCode/AXI_Stream_DMA/stream_ip_tbprj/axi_stream_tbprj/axi_stream_tbprj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_stream_loop_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_stream_loop_v1_0.tcl

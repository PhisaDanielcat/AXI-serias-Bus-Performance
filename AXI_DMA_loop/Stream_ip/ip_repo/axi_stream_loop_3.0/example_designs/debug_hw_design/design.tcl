...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axi_stream_loop_0/ctr_AXIlite]
	connect_bd_net [get_bd_pins axi_stream_loop_0/ctr_axilite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_stream_loop_0/ctr_axilite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	# Copy all address to axi_stream_loop_v3_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axi_stream_loop_v3_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axi_stream_loop_0_ctr_AXIlite_* ]]
	puts $fp "set ctr_axilite_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axi_stream_loop_v3_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axi_stream_loop_v3_0_hw_${i}"

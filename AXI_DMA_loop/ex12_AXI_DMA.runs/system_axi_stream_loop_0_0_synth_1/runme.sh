...
HD_PWD='D:/VivadoCode/AXI_Stream_DMA/AXI_DMA_loop/ex12_AXI_DMA.runs/system_axi_stream_loop_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_stream_loop_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_stream_loop_0_0.tcl
